    ...
    public partial class Oracle : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                ...
                c => new
                    {
                        EXPENSE_ID = c.Decimal(nullable: false, precision: 10, scale: 0, identity: true),
                        VENDOR_ID = c.Decimal(nullable: false, precision: 10, scale: 0),
                        EXPENSE_DATE = c.DateTime(nullable: false),
                        EXPENSE_AMOUNT = c.Decimal(nullable: false, precision: 18, scale: 2),
                    })
        ...
        public override void Down()
        {
            ...
            DropForeignKey("HERCULES.EXPENSES", "VENDOR_ID", "HERCULES.VENDORS");
            ...
            DropIndex("HERCULES.EXPENSES", new[] { "VENDOR_ID" });
